...
#include "../../../../../../../../Smartframe/Dependencies/Components/src/imports/application/quickstudioapplication_p.h"
...
template <> constexpr inline auto QuickStudioApplication::qt_create_metaobjectdata<qt_meta_tag_ZN22QuickStudioApplicationE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        // property 'fontPath'
        QtMocHelpers::PropertyData<QUrl>(7, QMetaType::QUrl, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 0),
    };
