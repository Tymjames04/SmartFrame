...
0xa0,0x4,0x0,0x0,0x37,0x32,0x33,0x31,
...
aotContext->setInstructionPointer(18);
#endif
aotContext->initGetObjectLookup(5, r2_5);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<double *>(argv[0]) = double();
...
aotContext->setInstructionPointer(34);
#endif
aotContext->initGetObjectLookup(9, r2_9);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<double *>(argv[0]) = double();
...
aotContext->setInstructionPointer(43);
#endif
aotContext->initGetObjectLookup(11, r2_11);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<double *>(argv[0]) = double();
...
aotContext->setInstructionPointer(49);
#endif
aotContext->initGetObjectLookup(13, r2_13);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<double *>(argv[0]) = double();
