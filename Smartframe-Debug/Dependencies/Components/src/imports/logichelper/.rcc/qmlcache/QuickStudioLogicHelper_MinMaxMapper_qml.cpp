...
0xc8,0x6,0x0,0x0,0x37,0x32,0x33,0x31,
...
aotContext->setInstructionPointer(10);
#endif
aotContext->initGetObjectLookup(11, r2_2);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<bool *>(argv[0]) = bool();
...
aotContext->setInstructionPointer(10);
#endif
aotContext->initGetObjectLookup(15, r2_2);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<double *>(argv[0]) = double();
...
aotContext->setInstructionPointer(15);
#endif
aotContext->initGetObjectLookup(17, r2_4);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<double *>(argv[0]) = double();
...
aotContext->setInstructionPointer(21);
#endif
aotContext->initGetObjectLookup(19, r2_6);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<double *>(argv[0]) = double();
