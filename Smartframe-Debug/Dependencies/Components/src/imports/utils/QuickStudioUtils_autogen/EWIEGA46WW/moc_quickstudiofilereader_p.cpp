...
#include "../../../../../../../../Smartframe/Dependencies/Components/src/imports/utils/quickstudiofilereader_p.h"
...
template <> constexpr inline auto QuickStudioFileReader::qt_create_metaobjectdata<qt_meta_tag_ZN21QuickStudioFileReaderE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        // property 'filePath'
        QtMocHelpers::PropertyData<QUrl>(8, QMetaType::QUrl, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 0),
        // property 'content'
