...
#include "../../../../../../../../Smartframe/Dependencies/Components/src/imports/utils/quickstudiocsvtablemodel_p.h"
...
template <> constexpr inline auto QuickStudioCsvTableModel::qt_create_metaobjectdata<qt_meta_tag_ZN24QuickStudioCsvTableModelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(const QString &)>(9, 6, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 10 },
        }}),
    };
    QtMocHelpers::UintData qt_properties {
        // property 'source'
        QtMocHelpers::PropertyData<QUrl>(11, QMetaType::QUrl, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 0),
    };
