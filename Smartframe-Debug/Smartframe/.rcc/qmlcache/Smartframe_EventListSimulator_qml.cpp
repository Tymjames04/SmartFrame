...
0xc0,0x7,0x0,0x0,0x37,0x32,0x33,0x31,
...
0x0,0x0,0x0,0x0,0xcf,0x7c,0xcf,0x11,
0x0,0xbe,0xe8,0x1c,0xa,0xc4,0x9b,0x96,
0x3a,0x12,0xdb,0xf,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
const auto doCall = [&]() {
    ...
    return aotContext->callObjectPropertyLookup(4, r11_0, args, 1);
};
const auto doInit = [&]() {
    aotContext->initCallObjectPropertyLookup(4, r11_0, 70);
};
#ifndef QT_NO_DEBUG
...
aotContext->setInstructionPointer(29);
#endif
aotContext->initGetObjectLookup(7, r2_3);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
return;
}
...
const auto doCall = [&]() {
    void *args[] = {nullptr};
    return aotContext->callObjectPropertyLookup(9, r7_1, args, 0);
};
const auto doInit = [&]() {
    aotContext->initCallObjectPropertyLookup(9, r7_1, 5);
};
#ifndef QT_NO_DEBUG
